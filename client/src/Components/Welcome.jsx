            ...
            <div className=" flex mf:flex-row flex-col items-start justify-between md:p-20 py-12 px-4">
                <div className=" flex flex-1 justify-start flex-col mf:mr-10">
                    ...
                    <p className=" text-left mt-5 text-white font-light md:w-9/12 w-11/12 text-base">
                        Explore the world of Cryptos,<br/>Payment made easier.
                    </p>
                ...
                <div className=" flex flex-1 flex-col items-center justify-start w-full mf:mt-0 mt-10">
                    <div className=" p-3 justify-end items-start flex-col rounded-xl h-40 sm:w-72 w-full my-5 shadow-2xl bg-gradient-to-br from-cyan-500 to-blue-400">
                    ...
                    <div className=" p-5 sm:w-96 w-full flex flex-col justify-start items-center blue-glassmorphism">
                        ...
                        {isLoading ? (
                            ...
                            <button
                                ...
                                className=" text-white w-full mt-2 border-[1px] p-2 border-[#0a42cf] rounded-full cursor-pointer"
                            >
                            Send Now    
                            </button>
                        )}
